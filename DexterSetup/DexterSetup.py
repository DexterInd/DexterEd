...
class MainPanel(wx.Panel):
	...
	def __init__(self, parent):
		...
		# Setup Wifi
		setup_wifi = wx.Button(self, label="Setup Wifi on Raspberry Pi.", pos=(25,75))
		setup_wifi.Bind(wx.EVT_BUTTON, self.setup_wifi)
		
		# Update Image on Sd Card
		update_image = wx.Button(self, label="Update Image on SD Card", pos=(25, 125))
		update_image.Bind(wx.EVT_BUTTON, self.update_image)			
		
		# Find your Pi
		find_pi = wx.Button(self, label="Find your Pi on the Network", pos=(25,175))
		find_pi.Bind(wx.EVT_BUTTON, self.find_pi)
